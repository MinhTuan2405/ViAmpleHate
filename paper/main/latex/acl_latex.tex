...
% Per author instruction, the Limitations and Ethics Statement sections were removed,
% and "Results and Analysis" (Sec. 6) + "Error Analysis" (Sec. 7) were merged into
% a single "Results and Error Analysis" section. NO numeric results were fabricated;
